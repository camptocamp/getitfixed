...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['category_id'], ['getitfixed.category.id'],
    ...
    op.create_table(
        ...
        sa.Column('request_date', sa.Date(), server_default=sa.text('now()'), nullable=False),
        sa.Column('type_id', sa.Integer(), nullable=False),
        sa.Column('description', sa.Text(), nullable=False),
        sa.Column('geometry',
                  geoalchemy2.types.Geometry(geometry_type='POINT', srid=4326, management=True),
                  nullable=True),
        sa.ForeignKeyConstraint(['type_id'], ['getitfixed.type.id'],
                                name=op.f('fk_issue_type_id_type')),
